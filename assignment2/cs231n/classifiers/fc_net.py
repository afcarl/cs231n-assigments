...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    layer2_out, layer2_cache = affine_forward(relu_out, self.params['W2'], self.params['b2'])
    ...
    dlayer1_out = relu_backward(drelu_out, relu_cache)

    dX, grads['W1'], grads['b1'] = affine_backward(dlayer1_out, layer1_cache)
